<!-- PORTFOLIO CONTEXT -->
**Subject:** Dependable AI (Y3) · IIT Jodhpur, Dept. of CSE & AI
**Problem:** Scalable multi-label classification for label spaces of 10⁴–10⁶ labels using approximate nearest neighbor search over learned label embeddings.
**Tech Stack:** C++11, OpenMP, Python (evaluation)
